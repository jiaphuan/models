...
def restore_fn(checkpoint_path):
  ...
  variables_to_restore = (get_variables_available_in_checkpoint(
...
def main(_):
  ...
  if worker_replicas >= 1 and ps_tasks > 0:
    ...
    is_chief = (task_info.index == 0)
    master = 'grpc://' + cluster_data['worker'][0]
  ...
  with tf.Graph().as_default():
    ...
    def clone_fn(batch_queue):
      ...
      return end_points # Gather initial summaries.
    ...
    if FLAGS.sync_replicas:
      ...
      optimizer = tf.train.SyncReplicasOptimizer(
          ...
          replica_id=tf.constant(task, tf.int32, shape=()),
